...
export class UserComponent extends BaseCtl {
  ...
  myFile(){
    console.log('user component ts my file()');
  ...
  onSubmitProfile(fileToUpload: File, userform : FormGroup) {
    console.log('user component ts on submit profile');
  ...
  validateForm(form) {
    console.log('user component ts validate()');
    let flag = true;
  ...
  populateForm(form, data) {
    console.log('user component ts populate');
    form.id = data.id;
  ...
  parseDate(dateString: string): Date {
    console.log('user component ts parsedate()');
    if (dateString) {
